...
```python
rqt.update(id_, old_x0, old_y0, old_x1, old_y1, new_x0, new_y0, new_x1, new_y1)
rqt_obj.update(id_, new_x0, new_y0, new_x1, new_y1)
```
...
| Before                     | After                          |
| -------------------------- | ------------------------------ |
| `qt.delete(id, (x, y))`    | `qt.delete(id_, x, y)`         |
...
class QuadTreeObjects:
    ...
    def delete_one_by_object(obj) -> bool: ...             # deletes one, lowest id_
    def clear(self) -> None: ...
...
class RectQuadTree:
    ...
    def query_np(self, rect): ...  # (ids: ndarray[int64], coords: ndarray[dtype] shape (N,4))
    ...
    # Deletion
    def delete(self, id_: int, x0: float, y0: float, x1: float, y1: float) -> bool: ...
    def clear(self) -> None: ...

    # Mutation
    def update(self, id_: int, old_x0: float, old_y0: float, old_x1: float, old_y1: float,
               new_x0: float, new_y0: float, new_x1: float, new_y1: float) -> bool: ...
...
class RectQuadTreeObjects:
    ...
    # Mutation
    def update(self, id_: int, new_x0: float, new_y0: float, new_x1: float, new_y1: float) -> bool: ...
